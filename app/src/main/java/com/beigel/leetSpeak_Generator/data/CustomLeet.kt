...
data class CustomLeet(
    ...
    fun copy(newName: String = this.name): CustomLeet =
        CustomLeet(newName, _translations.toMutableMap())

    companion object {
        /**
         * Creates a CustomLeet with default Simple Leet translations
         */
        fun createWithSimpleDefaults(name: String): CustomLeet {
            val leet = CustomLeet(name)
         ...
         */
        fun createWithExtendedDefaults(name: String): CustomLeet {
            val leet = CustomLeet(name)
